...
$$(foreach prof,$(1),$$(eval $$(call proftgt,$$(prof)-nomadexecremote,      $$(prof), true,false,false,false,false, nomadexecremote)))
$$(foreach prof,$(1),$$(eval $$(call proftgt,$$(prof)-nomadexecremote-auto, $$(prof), true,false, true,false,false, nomadexecremote)))
